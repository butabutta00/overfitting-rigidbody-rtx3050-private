...
$build_dir = Join-Path $project_root "cuda" "build"
$plugin_dir = Join-Path $project_root "VRTermProject" "Assets" "Plugins" "x86_64"
...
$dll_file_release = Join-Path $build_dir "Release" "mass_spring_native.dll"
