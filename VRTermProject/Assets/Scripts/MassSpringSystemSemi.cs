...
public class MassSpringSystemSemi : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // physicsSimulationSubDeltaTime = (Mathf.Log10(timeStep) / 3 + 2) / 1000f;
        physicsSimulationSubDeltaTime = Mathf.Log10(timeStep) / 2048f + 1/512f;
        physicsSimulationSliceSize = timeStep / physicsSimulationSubDeltaTime;
        framesSkippingRender = Mathf.Max(0, Mathf.CeilToInt(physicsSimulationSliceSize));
